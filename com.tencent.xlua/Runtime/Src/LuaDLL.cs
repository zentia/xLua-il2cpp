...
namespace XLua.LuaDLL
{
    ...
    public partial class Lua
    {
        ...
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern void lua_getglobal(IntPtr L, string name);

        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern void lua_getfield(IntPtr L, int index, string name);

        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern void lua_callk(IntPtr luaState, int nArgs, int nResults, int ctx, IntPtr k);
        ...
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr xlua_capture_mirrored_traceback(IntPtr L);
#if LUA_MEM_PROFILER
        [DllImport(LUADLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr luaT_print_stack(IntPtr L);
#endif
    }
}
